const News = {
    ...
    methods: {
        fetchArticles() {
            ...
            fetch("https://newsapi.org/v2/everything?q=tesla&from=2024-06-17&sortBy=publishedAt&apiKey=6d9c90bee93d417a9e02cda2b6350693")
        ...
        fetchOtherArticles(page = 1) {
            fetch("https://newsapi.org/v2/everything?q=apple&from=2024-07-16&to=2024-07-16&sortBy=popularity&apiKey=6d9c90bee93d417a9e02cda2b6350693")
                .then(response => response.json())
                .then(data => {
